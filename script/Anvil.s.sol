...
contract EstateHookScript is Script {
    ...
    function run() public {
        ...
        (address hookAddress, bytes32 salt) =
            HookMiner.find(CREATE2_DEPLOYER, permissions, type(EstateHook).creationCode, abi.encode(address(manager)));
        ...
        vm.startBroadcast();
        testLifecycle(manager, address(estate), lpRouter, swapRouter);
        vm.stopBroadcast();
    }
